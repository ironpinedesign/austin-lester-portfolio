...
export default function Studio({claimed,isOwner,displayName,projects,slots,initialSettings,signOutUrl,provider}:{claimed:boolean;isOwner:boolean;displayName:string;projects:{slug:string;title:string;number:string}[];slots:MediaSlot[];initialSettings:SiteSettings;signOutUrl:string|null;provider:'openai-sites'|'cloudflare-access'}){
